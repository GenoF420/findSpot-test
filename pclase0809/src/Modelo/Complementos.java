...
/*
  6 . Debe entregar el total vendido por tipo de estado de la solicitud. 
  7 . Ingresar un cliente, teniendo como regla que el nombre no puede tener menos de 5 letras, la dirección menos de 10 y el correo y telefono no puede estar vacio. 
  8 .  Ingresar un producto, donde el código debe ser asignado automáticamente y no debe repetirse con alguno de los existentes. 
  9 .  Imprimir Su nombre-Apellido-Correo
  10. Salir  */
    ...
    public int Menu(){
        ...
        System.out.println("6... Total vendido por solicitud");
        System.out.println("7... Ingresar Cliente");
        System.out.println("8... Ingresar Producto");
        System.out.println("9... Datos");
